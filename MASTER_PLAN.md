...
- [ ] P1.02 Compatibility gating v2: make gating rule-driven and consistent for every category (not just “error rules” for products and a couple heuristics for plants).
